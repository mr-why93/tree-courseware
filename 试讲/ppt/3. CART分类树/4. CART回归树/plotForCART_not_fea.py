...
'''树是字典形式，树可视化，key是最优特征，value是决策点(字典)或者是叶子节点(值)'''
...
def getNumLeafs(myTree):
    ...
    secondDict=[myTree[list(myTree.keys())[3]],myTree[list(myTree.keys())[4]]]   ###++修改了
...
def plotTree(myTree, parentPt, nodeTxt):
    ...
    plotMidText(cntrPt, parentPt, '')  #在父子决策结点间填充文本信息
