 尹立岩|退出
首页 天池大赛 学习 数据集 激励 众智平台 技术圈 达摩院招聘  
首页> 技术圈> 人工智能辅助糖尿病遗传风险预测 XGBoost, LightGBM, NN,CATBOOST and OLS实验代码 线上0.8429
Article
人工智能辅助糖尿病遗传风险预测 XGBoost, LightGBM, NN,CATBOOST and OLS实验代码 线上0.8429
 吴飞 最后更新 2018-01-20 12:33:26 回复 7 浏览 1390
 
参照https://www.kaggle.com/aharless/xgboost-lightgbm-and-ols-and-nn
下一步继续调参 线下验证
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
查看Gitlab代码 复制创建PAI实验
富文本 评论
文本、代码、图片...


黄金时代:
你好，这样进行模型融合的依据（或实际意义）是是什么呢？

2018-01-20 19:33:28  1楼 0回复

菜鸟大师:好复杂......不如找特征
2018-01-23 14:32:49  2楼 0回复

吴飞:回复@黄金时代 参见这个文章里面的模型融合 http://blog.csdn.net/Irving_zhang/article/details/78561105
2018-01-23 19:52:35  3楼 0回复

JQ数据:权重的值是怎么定的呢？
2018-01-24 13:52:13  4楼 0回复

吴飞:回复@JQ数据 可调
2018-01-24 19:53:04  5楼 0回复

testispuncher:回复@吴飞 你引用的作者直接抄了别人的代码,原链接在这https://www.kaggle.com/serigne/stacked-regressions-top-4-on-leaderboard
2018-01-26 12:02:14  6楼 0回复

testispuncher:回复@黄金时代 可以参考这篇文献http://statistics.berkeley.edu/sites/default/files/tech-reports/367.pdf
2018-01-26 12:04:14  7楼 0回复
<<<1>>>
...
热门产品
云服务器ECS云数据库RDS云存储OSSNAT网关负载均衡域名注册网站建设大数据云计算
用户热搜
网站备案网安法CDN加速API网关企业邮箱whois查询视频直播视频转码云安全
更多推荐
全民云计算免费套餐学生机IT论坛数据可视化云虚机com域名cn域名合规安全解决方案
关于我们 法律声明 廉正举报 友情链接
